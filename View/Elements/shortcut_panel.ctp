<script src="<?php echo $this->Html->url('/debug_kit_shortcut/js/shortcut.js'); ?>" type="text/javascript"></script>
<script src="<?php echo $this->Html->url('/debug_kit_shortcut/js/debug_kit_shortcut.js'); ?>" type="text/javascript"></script>
<div class="debug-info">
    <h2>Shortcut</h2>

    <?php echo $this->Toolbar->makeNeatArray(array(
      ...
      'T' => __('Toggle Maximize/Minimize  Panel', true),
      )); ?>
